		...
		<header class="row">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light row" style="background-color: #e3f2fd;">
				<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
					...
					<li class="nav-item" role="presentation">
						<a class="nav-link active" id="pills-quanLy-tab" data-toggle="pill" href="#pills-quanLy" role="tab" aria-controls="pills-quanLy" aria-selected="true"><i class="fas fa-shopping-basket"></i> Quản lý đơn hàng</a>
					</li>
					<li class="nav-item" role="presentation">
			...
			<div class="container-fluid">
				<div class="tab-pane fade show active" id="pills-quanLy" role="tabpanel" aria-labelledby="pills-quanLy-tab">
					<a class="btn btn-primary" href="search.php" role="button">Tìm kiếm</a>
						<a class="btn btn-primary " style="float:right;" href="them.php" role="button">Thêm đơn hàng</a>
						<br>
						<br>
						<table class="table table-bordered" border="1">
							...
							$query=mysqli_query($conn,"select * from `donhang`");
							while($row=mysqli_fetch_array($query)){
								...
								<tr>
									...
									<td><a href="xemchitiet.php?id=<?php echo $row['id']; ?>">Chi tiết</a></td>
								</tr>
							</tbody>
								<?php
							}
