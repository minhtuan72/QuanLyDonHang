...
<body>
        ...
        <header class="row">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light row" style="background-color: #e3f2fd;">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="pills-doimk-tab" data-toggle="pill" href="#pills-doimk" role="tab" aria-controls="pills-doimk" aria-selected="false">  <i class="fas fa-file"></i> Sản phẩm</a>
                    </li>
                    <li class="nav-item" role="presentation">
    ...
    <form action="" method="post">
        <input class="form-control col-8" type="text" name="search">
        <br>
        <input class="btn btn-outline-primary col-2" type="submit" name="submit" value="Tìm kiếm">
    </form>
    <br>
    <?php
        ...
        <div>
            <h2>Kết quả<br></h2>
                ...
                <table class="table table-bordered" border="1">
                    <thead class="thead-light show action">
                        <tr>
                            <th>ID</th>
                            <th>Mã Đơn Hàng</th>
                            <th>Ngày Lập</th>
 ...
 <?php
            $query = mysqli_query($conn, "SELECT * FROM `donhang` WHERE `hoTen` LIKE '%$keyword%' ORDER BY `hoTen`") or die(mysqli_error());
                ...
                ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $fetch['maDH']; ?></td>
                            <td><?php echo $fetch['ngayLap']; ?></td>
                            <td><?php echo $fetch['hoTen']; ?></td>
                            <td><?php echo $fetch['sdt']; ?></td>
                            <td><?php echo $fetch['diaChi']; ?></td>
                            <td><?php echo $fetch['ngayGiao']; ?></td>
                            <td><?php echo $fetch['soLuong']; ?></td>
                            <td><?php echo $fetch['tongTien']; ?></td>
                            <td><?php echo $fetch['trangThai']; ?></td>
                            <td><a href="sua.php?id=<?php echo $fetch['id']; ?>">Sửa</a></td>
                            <td><a href="xoa.php?id=<?php echo $fetch['id']; ?>">Xóa</a></td>
                            <td><a href="xemchitiet.php?id=<?php echo $fetch['id']; ?>">Chi tiết</a></td>
                        </tr>
                    </tbody>
                    <?php
                }
