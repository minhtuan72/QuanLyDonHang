...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if(isset($_POST["maDH"])) { $maDH = $_POST['maDH']; }
    if(isset($_POST["ngayLap"])) { $ngayLap = $_POST['ngayLap']; }
    ...
    $sql = "INSERT INTO donhang (maDH, ngayLap, hoTen, sdt, diaChi, ngayGiao, soLuong, tongTien, trangThai)
    VALUES ('$maDH', '$ngayLap', '$hoTen', '$sdt', '$diaChi', '$ngayGiao', '$soLuong', '$tongTien', '$trangThai')";
                            ...
                            <table>
                               <div class="col-sm-6 justify-content-center">
                                 <div class="form-group ">
                                    ...
                                    <input type="text" name="maDH" class="form-control" value="" required/>
                                </div>


                                <div class="form-group">
                                    <label for="exampleInputNgayLap">Ngày lập</label>
                                    <input type="date" name="ngayLap" class="form-control" value="" required/>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="ngayGiao" class="form-control" value="" required/>
                                </div> 

                                <div class="form-group">
                                    <label for="soLuong">Số lượng</label>
                                    <input type="text" name="soLuong" class="form-control" value="" required/>
                                </div> 

                                <div class="form-group">
                                    <label for="tongTien">Tổng tiền (VNĐ)</label>
                                    <input type="text" name="tongTien" class="form-control" value="" required/>
                                </div> 

                                <div class="form-group">
                                    <label for="trangThai">Trạng Thái</label>
                                    <input type="text" name="trangThai" class="form-control" value="" required/>
                                </div>
