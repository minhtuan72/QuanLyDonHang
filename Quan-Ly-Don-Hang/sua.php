...
<body>
	...
	$id=$_GET['id'];
	$query=mysqli_query($conn,"select * from `donhang` where id='$id'");
	...
	if (isset($_POST['update_donhang'])){
		...
		$trangThai=$_POST['trangThai'];
									...
									// Create connection
		$conn = new mysqli("localhost", "root", "", "qldh");
									// Check connection
		if ($conn->connect_error) {
			die("Connection failed: " . $conn->connect_error);
		}

		$sql = "UPDATE `donhang` SET maDH='$maDH', ngayLap='$ngayLap', hoTen='$hoTen', sdt='$sdt', diaChi='$diaChi', ngayGiao='$ngayGiao', soLuong='$soLuong', tongTien='$tongTien', trangThai='$trangThai' WHERE id='$id'";
					...
					<div class="tab-pane fade show active" id="pills-quanLy" role="tabpanel" aria-labelledby="pills-quanLy-tab">
                            ...
                            <table>
                               <div class="col-sm-6 justify-content-center">
                                 <div class="form-group ">
                                    <label for="exampleInputMaDH">Mã đơn hàng</label>
                                    <input type="text" name="maDH" class="form-control" value="<?php echo $row['maDH']; ?>" required/>
                                </div>


                                <div class="form-group">
                                    <label for="exampleInputNgayLap">Ngày lập</label>
                                    <input type="date" name="ngayLap" class="form-control" value="<?php echo $row['ngayLap']; ?>" required/>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sdt" class="form-control" value="<?php echo $row['sdt']; ?>" required/>
                                </div> 
                                ...
                                <div class="form-group">
                                    <label for="ngayGiao">Ngày giao dự kiến</label>
                                    <input type="date" name="ngayGiao" class="form-control" value="<?php echo $row['ngayGiao']; ?>" required/>
                                </div> 

                                <div class="form-group">
                                    <label for="soLuong">Số lượng</label>
                                    <input type="text" name="soLuong" class="form-control" value="<?php echo $row['soLuong']; ?>" required/>
                                </div> 

                                <div class="form-group">
                                    <label for="tongTien">Tổng tiền (VNĐ)</label>
                                    <input type="text" name="tongTien" class="form-control" value="<?php echo $row['tongTien']; ?>" required/>
                                </div> 

                                <div class="form-group">
                                    <label for="trangThai">Trạng Thái</label>
                                    <input type="text" name="trangThai" class="form-control" value="<?php echo $row['trangThai']; ?>" required/>
                                </div>
							...
							<input type="submit" value="Cập nhật" name="update_donhang">
							<?php
